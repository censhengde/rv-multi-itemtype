 ...
 */
class FooterMultiItem : SimpleMultiItem<CheckableBean>() {


    override fun getItemLayoutRes(): Int = R.layout.item_checking_footer

    override fun isMatchForMe(bean: Any?, position: Int): Boolean = (bean as CheckableBean).viewType == CheckableBean.VIEW_TYPE_FOOTER
